            ...
            <div className="bg-[#EEFFEF] w-full md:w-3/4 lg:w-1/3 mx-auto p-10 mt-10">
                ...
                <form className="">
                    ...
                    <div className="form-control mt-6">
                        <button onClick={handleLogin} className=" py-2 rounded-md bg-[#A1400B] text-white">Sign In</button>
                    </div>
                    <div>
                ...
                <p className="text-xl mt-10">If you are new please <NavLink to={"/sign-up"}><span className="text-[#A1400B] font-extrabold">Sign Up here</span></NavLink></p>
